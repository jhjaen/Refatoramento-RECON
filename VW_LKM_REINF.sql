CREATE OR REPLACE VIEW VW_LKM_REINF AS
...
SELECT DISTINCT
               ...
               'ESOCIAL'                                                          BKTXT, -- DSC_IMPOSTO
               '100000346'                                                        LIFNR, -- COD_PREVIDENCIA SOCIAL --<(Ajuste conforme e-mail anderson dia 29.04.2019)
               ...
               CASE WHEN X.COD_RETENCAO = '2658'
                ...
                --,DECODE(X.COD_RETENCAO,'2100','PF','PJ')TP_REINF
